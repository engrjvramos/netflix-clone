  ...
  return (
    <div className="mt-6 grid grid-cols-1 gap-x-4 border px-4 md:grid-cols-4 md:border-x-0 md:border-t md:border-b-0 md:px-0">
      <div className="space-y-2 py-4">
        ...
        >
          {isBillingLoading ? (
            <CgSpinner className="animate-spin m-auto h-7 w-7 text-gray-200 dark:text-transparent dark:fill-[#e50914]" />
          ) : (
            "Cancel Membership"
          )}
        </button>
      ...
      <div className="col-span-3">
        ...
        <div className="flex flex-col md:flex-row justify-between pt-4 pb-4 md:pb-0">
          <div>
            <p>
